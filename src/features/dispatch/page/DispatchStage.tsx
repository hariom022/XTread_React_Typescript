...
import type { DispatchTeam, ProductionSuccessData, CustomerDeliveryPayload, DispatchFinalizationRow } from "../type/dispatch.types";
...
const DispatchStage =
    () => {
        ...
        const [finalDispatchList, setFinalDispatchList] = useState<DispatchFinalizationRow[]>([]);

        const [productionData, setProductionData] = useState<ProductionSuccessData | null>(null,);
