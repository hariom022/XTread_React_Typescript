...
const EnvelopingBatchModal = ({
 ...
 selectedRailId,
  ...
  const selectedRail = rails.find(
  (x) => x.railId === selectedRailId
);

  const [selectedAllocatedRow, setSelectedAllocatedRow] =
    useState<AllocatedRailRow | null>(null);

  const usedRailNumbers = allocatedRows.map((x) => String(x.railNo));
        ...
        <div className="modal-dialog modal-xl modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-header bg-danger text-white">
              <h4 className="modal-title">ENVELOPING BATCH</h4>
            ...
            <div className="modal-body">
              ...
              >
                <h5 className="fw-bold mb-0">Ramp Rail - Casing Allocation</h5>
    ...
    <b>{selectedRail.name}</b>
              ...
              <div className="table-responsive">
                <table className="table table-bordered table-hover">
                  ...
                  <tbody>
                    {filteredRows.map((item: EnvelopingRow) => (
  ...
  .map((pipe) => (
    ...
    >
      {pipe.pipeName}
              ...
              <div className="mt-4">
                <h6 className="fw-bold">Allocated Rail Location to Casings</h6>
                ...
                <table className="table table-bordered table-hover">
                  ...
                  <tbody>
                    {allocatedRows.length === 0 ? (
                      ...
                      allocatedRows.map((item: AllocatedRailRow) => (
                        <tr key={item.orderCasingId}>
                          <td>
                            <input
                              type="checkbox"
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (selectedAllocatedRow) {
                        removeFromRail(selectedAllocatedRow);
            ...
            <div className="modal-footer">
              ...
              <button className="btn btn-success" onClick={processEnvelope}>
                Process Envelope
              </button>
            </div>
          </div>
