...
const QualityControl = () => {
    ...
    const handleInspect = async (
        ...
        await qualityModal.openInspection(
            item.orderCasingId,
        );
    ...
    return (
        <div className="container-fluid mt-3">
            ...
            {showModal && (
                    <QualityControlModal
                        show={showModal}
                        details={qualityModal.details}
                        rejectReason={qualityModal.rejectReason}
                        setRejectReason={
                            qualityModal.setRejectReason
                        }
                        rejectComment={
                            qualityModal.rejectComment
                        }
                        setRejectComment={
                            qualityModal.setRejectComment
                        }
                        onApprove={() => {
                            alert("Approve API Pending");
