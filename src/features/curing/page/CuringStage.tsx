        ...
        <div className="container-fluid box mt-3">
            ...
            <div className="col">
                ...
                <ul className="nav nav-tabs mb-3">
                    <li className="nav-item">
                        <button
                            className={`nav-link ${activeChamberTab ===
                                "Marangoni"
                                ? "active"
                                : ""
                                }`}
